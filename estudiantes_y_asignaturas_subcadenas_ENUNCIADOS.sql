...
-- "Juan Pérez estudia Ingeniería de Sistemas y tiene una media de 8.5"

SELECT CONCAT(NOMBRE,' ESTUDIA ',CARRERA,' Y TIENE UNA MEDIA DE ',NOTA_MEDIA) FROM ESTUDIANTES
